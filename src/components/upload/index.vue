<template>
  <div class='vui-upload' >
    <input v-if='multiple' type='file' id='vui-upload-input' ref="vuiFileInput" @change="upload" :accept="accept" multiple/>
    <input v-else type='file' id='vui-upload-input' ref="vuiFileInput" @change="fileSelected" :accept="accept"/>
    ...
    <div class='vui-upload-list' v-if="showUploadList">
      <div :class='[file.status,"vui-upload-item"]' v-for="file in fileList" :key='file.key'>
        <div class='vui-upload-item-info'>
          <span>{{file.name}}</span>
          <svg @click='remove(file)' class="vui-upload-item-remove" fill="currentColor" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1973" xmlns:xlink="http://www.w3.org/1999/xlink" width="200" height="200">
            <path d="M810.666667 273.493333L750.506667 213.333333 512 451.84 273.493333 213.333333 213.333333 273.493333 451.84 512 213.333333 750.506667 273.493333 810.666667 512 572.16 750.506667 810.666667 810.666667 750.506667 572.16 512z" p-id="1974"></path>
          </svg>
        </div>
