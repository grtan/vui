<template>
  <div :class="$style.root">
    ...
    <vui-popup v-model="show" direction="up" :overlayer="false" :class="$style.wrapper">
      <div :class="$style.content">
        <div>popup-up</div>
        <VuiButton type="gorgeous" @click="show = false" hue="success" :block="true" :class="$style.close"
          >关闭</VuiButton
        >
      </div>
    </vui-popup>
